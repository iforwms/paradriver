<div class="fender_jazz">
    ...
    <div style="margin-right: 2em; flex-direction: column; text-align: center; line-height: 1.5; background: radial-gradient(#f48535, #241100); border: 2px solid #623915; display: flex; justify-content: center; align-items: center; border-radius: 12px; padding: 1em;">
